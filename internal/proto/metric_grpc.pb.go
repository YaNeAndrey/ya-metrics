...
func (c *metricsClient) UpdateMetric(ctx context.Context, in *MetricRequest, opts ...grpc.CallOption) (*MetricResponse, error) {
...
func (UnimplementedMetricsServer) UpdateMetric(context.Context, *MetricRequest) (*MetricResponse, error) {
